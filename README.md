...
<p align='center'>
  <img src="/renders/render_512_10.gif" alt="Compressed gif of render" width="512">
</p>
...
![Frame of high fidelity simulation](/output/frame_0027.png)

This is a 2048x2048 frame from early in the simulation. 
See `output/` and `renders/` for more output from a 1024x1024 sim at 120 updates per second and 30fps (rendering every 4th frame), and 4 minutes worth of simulation. This took around 6 hours to complete (single threaded). 

It's worth noting that the `interesting' parts of the simulation are really only in the first 30 seconds, so a high quality and fun-to-look-at simulation can take as little as a few minutes. 

...
See `output/` for more output. These are 1024x1024 resolution generated at 120 updates per second and 30fps (rendering every 4th frame), and 4 minutes worth of simulation. This took around 6 hours to complete (single threaded). It's worth noting that the `interesting' parts of the simulation are really only in the first 30 seconds, so a high quality and fun-to-look-at simulation can take as little as a few minutes.
